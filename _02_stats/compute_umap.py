...
SINGLE_DS = "test"      # "train" / "validation" / "test", usato solo se MODE == "single"
...
def main():
    ...
    out_dir = Path(OUTPUT_DIR) if OUTPUT_DIR else os.path.join(current_file.parent, "umap_results")
    ...
    if INTERACTIVE:
        ...
        filename = "umap_" + ("_".join(MODALITIES.keys()) + "_") + ("all" if MODE == "all" else SINGLE_DS)
